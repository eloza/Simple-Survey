...
var config = {
    ...
    databaseURL: "https://simplesurvey-5a715.firebaseio.com",
    storageBucket: "simplesurvey-5a715.appspot.com",
    ...
    if(this.state.name && this.state.submitted === false){
      ...
      questions = <span>
        ...
        <div>
          ...
          <input type="radio" name="q3" value="ApplePhone" onChange={this.handleQuestionChange} />Apple<br />
          <input type="radio" name="q3" value="NexusPhone" onChange={this.handleQuestionChange} />Nexus<br />
          <input type="radio" name="q3" value="SamSungPhone" onChange={this.handleQuestionChange} />Samsung<br />
          <input type="radio" name="q3" value="BlackberryPhone" onChange={this.handleQuestionChange} />Blackberry<br />
      ...
      user = <span>
        <h2>Please enter your name to start the survey</h2>
